...
const CandidateBulkUpload = () => {
    ...
    const fetchCustomerInfo = useCallback(async () => {
        ...
        const url = `https://octopus-app-www87.ondigitalocean.app/branch/candidate-application/listings?customer_id=${customer_id}&branch_id=${branch_id}&_token=${branch_token}`;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                "https://octopus-app-www87.ondigitalocean.app/branch/candidate-application/bulk-create",
                {
                    method: "POST",
