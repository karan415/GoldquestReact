...
const Demo = () => {
    const generatePDF = () => {
        ...
        doc.text(text, xPosition, textY + 20);        // Table
        const tableData = [
            { sn: 1, applicationId: 'APP001', applicantName: 'John Doe' },
            { sn: 2, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 3, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 4, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 5, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 6, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 7, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 8, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 9, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 10, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 11, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 12, applicationId: 'APP002', applicantName: 'Jane Smith' },
            { sn: 13, applicationId: 'APP002', applicantName: 'Jane Smith' },
        ];
    ...
    return (
        <div onClick={generatePDF}>Demo</div>
    )
}
